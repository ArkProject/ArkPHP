...
class OtplCompiler{
	...
	public function compile(){
		...
		$header='<?php /* This file is Auto-generated by ArkPHP framework(DO NOT EDIT MANUALLY IT) in '. time() .'. */'.chr(13).chr(10).' defined ( \'ARK\' ) or exit ( \'access denied\' ); ?>'.chr(13).chr(10);
		
		$path=ark_combine($path,$this->state['uuid'].'.php');
		file_put_contents($path, $header.$this->result);
